...
const CACHE_NAME = "herdharbor-shell-v1.8.1-alpha-october-subscription-launch-referrals-credits-4-flow-phase2-2";
const APP_SHELL = [
  "./",
  "./index.html",
...
const NETWORK_FIRST_PATHS = [
  ...
  "/direct-transfer-v1.8.2.js",
  "/direct-transfer-v1.8.2.css",
