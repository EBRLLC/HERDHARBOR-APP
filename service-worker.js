...
const CACHE_NAME = "herdharbor-shell-v1.6.7-alpha-completion-debt-1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json?v=1.6.7",
  "./herdharbor-release-v1.6.1.js?v=1.6.7",
  "./herdharbor-membership-v1.6.1.js?v=1.6.7",
  "./herdharbor-billing-v1.6.1.js?v=1.6.7",
  "./herdharbor-access-cache-v1.6.1.js?v=1.6.7",
  "./herdharbor-cloud.js?v=19",
  "./herdharbor-admin-v1.6.1.js?v=1.6.7",
  "./herdharbor-core-v1.6.1.css?v=1.6.7",
  "./herdharbor-v1.6.1.css?v=1.6.7",
  "./herdharbor-build.js?v=1.6.7",
  "./analytics-v1.6.1.css?v=1.6.7",
  "./market-analytics-v1.6.5.js?v=1.6.7",
  "./analytics-v1.6.1.js?v=1.6.7",
  "./herdharbor-monitoring-config.js?v=1.6.7",
  "./vendor/herdharbor-monitoring-v1.6.1.min.js?v=1.6.7",
  "./symptom-guide.js?v=1",
  "./pwa.js?v=27",
  "./pedigree-visual.css?v=2",
  "./pedigree-visual.js?v=2",
  "./pedigree-genetics-v1.6.1.css?v=1.6.7",
  "./pedigree-genetics-v1.6.1.js?v=1.6.7",
  "./breeding-intelligence-core-v1.6.1.js?v=1.6.7",
  "./rabbit-genetics-v1.6.1.js?v=1.6.7",
  "./standards-registry-v1.6.1.js?v=1.6.7",
  "./multispecies-genetics-v1.6.1.js?v=1.6.7",
  "./standards-genetics-ui-v1.6.1.js?v=1.6.7",
  "./standards-genetics-v1.6.1.css?v=1.6.7",
  "./rabbit-records-v1.6.1.js?v=1.6.7",
  "./rabbit-genetics-engine-advanced-v1.6.1.js?v=1.6.7",
  "./rabbit-genetics-engine-compat-v1.6.1.js?v=1.6.7",
  "./rabbit-genetics-runtime-v1.6.1.js?v=1.6.7",
  "./breeding-intelligence-v1.6.1.css?v=1.6.7",
  "./breeding-genetics-advanced-v1.6.1.css?v=1.6.7",
  "./breeding-intelligence-v1.6.1.js?v=1.6.7",
  "./breeding-pair-v1.6.1.js?v=1.6.7",
  "./rabbit-genetics-ui-compat-v1.6.1.js?v=1.6.7",
  "./rabbit-genetics-ui-advanced-v1.6.1.js?v=1.6.7",
  "./breeding-intelligence-tools-v1.6.1.js?v=1.6.7",
  "./shows-v1.6.1.css?v=1.6.7",
  "./shows-v1.6.1.js?v=1.6.7",
  "./shows-v1.6.1-hardening.js?v=1.6.7",
  "./shows-v1.6.1-performance.js?v=1.6.7",
