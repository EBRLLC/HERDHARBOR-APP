...
const CACHE_NAME = "herdharbor-shell-v1.6.5-alpha-analytics-market-foundation-1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json?v=1.6.5",
  "./herdharbor-release-v1.6.1.js?v=1.6.5",
  "./herdharbor-membership-v1.6.1.js?v=1.6.5",
  "./herdharbor-billing-v1.6.1.js?v=1.6.5",
  "./herdharbor-access-cache-v1.6.1.js?v=1.6.5",
  "./herdharbor-cloud.js?v=19",
  "./herdharbor-admin-v1.6.1.js?v=1.6.5",
  "./herdharbor-core-v1.6.1.css?v=1.6.5",
  "./herdharbor-v1.6.1.css?v=1.6.5",
  "./herdharbor-build.js?v=1.6.5",
  "./analytics-v1.6.1.css?v=1.6.5",
  "./market-analytics-v1.6.5.js?v=1.6.5",
  "./analytics-v1.6.1.js?v=1.6.5",
  "./herdharbor-monitoring-config.js?v=1.6.5",
  "./vendor/herdharbor-monitoring-v1.6.1.min.js?v=1.6.5",
  "./symptom-guide.js?v=1",
  "./pwa.js?v=26",
  "./pedigree-visual.css?v=2",
  "./pedigree-visual.js?v=2",
  "./pedigree-genetics-v1.6.1.css?v=1.6.5",
  "./pedigree-genetics-v1.6.1.js?v=1.6.5",
  "./breeding-intelligence-core-v1.6.1.js?v=1.6.5",
  "./rabbit-genetics-v1.6.1.js?v=1.6.5",
  "./standards-registry-v1.6.1.js?v=1.6.5",
  "./multispecies-genetics-v1.6.1.js?v=1.6.5",
  "./standards-genetics-ui-v1.6.1.js?v=1.6.5",
  "./standards-genetics-v1.6.1.css?v=1.6.5",
  "./rabbit-records-v1.6.1.js?v=1.6.5",
  "./rabbit-genetics-engine-advanced-v1.6.1.js?v=1.6.5",
  "./rabbit-genetics-engine-compat-v1.6.1.js?v=1.6.5",
  "./rabbit-genetics-runtime-v1.6.1.js?v=1.6.5",
  "./breeding-intelligence-v1.6.1.css?v=1.6.5",
  "./breeding-genetics-advanced-v1.6.1.css?v=1.6.5",
  "./breeding-intelligence-v1.6.1.js?v=1.6.5",
  "./breeding-pair-v1.6.1.js?v=1.6.5",
  "./rabbit-genetics-ui-compat-v1.6.1.js?v=1.6.5",
  "./rabbit-genetics-ui-advanced-v1.6.1.js?v=1.6.5",
  "./breeding-intelligence-tools-v1.6.1.js?v=1.6.5",
  "./herdharbor-release-v1.6.1.js?v=1.6.5",
  "./shows-v1.6.1.css?v=1.6.5",
  "./shows-v1.6.1.js?v=1.6.5",
  "./shows-v1.6.1-hardening.js?v=1.6.5",
  "./shows-v1.6.1-performance.js?v=1.6.5",
