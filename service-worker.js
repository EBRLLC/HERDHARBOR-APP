...
const APP_SHELL = [
  ...
  "./herdharbor-release-v1.6.1.js?v=1.7.0",
  "./herdharbor-membership-v1.6.1.js?v=1.7.0",
  "./herdharbor-billing-v1.6.1.js?v=1.7.0",
  "./herdharbor-access-cache-v1.6.1.js?v=1.7.0",
  "./herdharbor-cloud.js?v=19",
  "./herdharbor-admin-v1.6.1.js?v=1.7.0",
  "./herdharbor-core-v1.6.1.css?v=1.7.0",
  "./herdharbor-v1.6.1.css?v=1.7.0",
  "./herdharbor-build.js?v=1.7.0",
  "./analytics-v1.6.1.css?v=1.7.0",
  "./market-analytics-v1.6.5.js?v=1.7.0",
  "./analytics-v1.6.1.js?v=1.7.0",
  "./herdharbor-monitoring-config.js?v=1.7.0",
  "./vendor/herdharbor-monitoring-v1.6.1.min.js?v=1.7.0",
  "./symptom-guide.js?v=1",
  "./pwa.js?v=28",
  "./pedigree-visual.css?v=2",
  "./pedigree-visual.js?v=2",
  "./pedigree-genetics-v1.6.1.css?v=1.7.0",
  "./pedigree-genetics-v1.6.1.js?v=1.7.0",
  "./breeding-intelligence-core-v1.6.1.js?v=1.7.0",
  "./rabbit-genetics-v1.6.1.js?v=1.7.0",
  "./standards-registry-v1.6.1.js?v=1.7.0",
  "./multispecies-genetics-v1.6.1.js?v=1.7.0",
  "./standards-genetics-ui-v1.6.1.js?v=1.7.0",
  "./standards-genetics-v1.6.1.css?v=1.7.0",
  "./rabbit-records-v1.6.1.js?v=1.7.0",
  "./rabbit-genetics-engine-advanced-v1.6.1.js?v=1.7.0",
  "./rabbit-genetics-engine-compat-v1.6.1.js?v=1.7.0",
  "./rabbit-genetics-runtime-v1.6.1.js?v=1.7.0",
  "./breeding-intelligence-v1.6.1.css?v=1.7.0",
  "./breeding-genetics-advanced-v1.6.1.css?v=1.7.0",
  "./breeding-intelligence-v1.6.1.js?v=1.7.0",
  "./breeding-pair-v1.6.1.js?v=1.7.0",
  "./rabbit-genetics-ui-compat-v1.6.1.js?v=1.7.0",
  "./rabbit-genetics-ui-advanced-v1.6.1.js?v=1.7.0",
  "./breeding-intelligence-tools-v1.6.1.js?v=1.7.0",
  "./shows-v1.6.1.css?v=1.7.0",
  "./shows-v1.6.1.js?v=1.7.0",
  "./shows-v1.6.1-hardening.js?v=1.7.0",
  "./shows-v1.6.1-performance.js?v=1.7.0",
