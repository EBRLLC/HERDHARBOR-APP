...
(() => {
  ...
  function greatPyreneesOutline() {
    return `<img class="species-outline species-outline-dog" src="data:image/png;base64," alt="Great Pyrenees default image">`;
  }
  ...
  function breedingSchedule(femaleId, breedingDate) {
    const female = state.animals.find((animal) => animal.id === femaleId);
  ...
  function syncBreedingReminders(breeding, options = {}) {
    ...
    const female = state.animals.find((animal) => animal.id === breeding.femaleId);
    const rule = GESTATION_RULES[female?.species];
  ...
  function breedingReportSnapshot(breedings = state.breedings, litters = state.litters, animals = state.animals) {
  ...
  function breedingYears() {
    return [...new Set([
      ...
      ...state.breedings.map((record) => Number(String(record.breedingDate || "").slice(0, 4))),
      ...state.litters.map((record) => Number(String(record.birthDate || "").slice(0, 4)))
  ...
  function renderBreedings() {
    ...
    const reportLitters = state.litters.filter((litter) =>
      ...
      ${rows.length ? `<div class="panel data-table-wrap">
        <table class="data-table">
          ...
          <tbody>${rows.map((record) => {
            const female = state.animals.find((animal) => animal.id === record.femaleId);
            const status = normalizeBreedingStatus(record.status);
            const linkedBirth = state.litters.find((litter) => litter.breedingId === record.id);
            return `<tr>
  ...
  function openBreedingForm(id = "") {
    ...
    const breeding = state.breedings.find((record) => record.id === id) || {};
    ...
    form.addEventListener("submit", (event) => {
      event.preventDefault();
      const data = Object.fromEntries(new FormData(event.currentTarget));
      const female = state.animals.find((animal) => animal.id === data.femaleId);
      const male = state.animals.find((animal) => animal.id === data.maleId);
    ...
    $("#delete-breeding")?.addEventListener("click", () => {
      ...
      state.litters.forEach((litter) => {
        if (litter.breedingId === id) {
          litter.breedingId = "";
          litter.updatedAt = now;
        }
      });
      state.breedings = state.breedings.filter((record) => record.id !== id);
  ...
  function selectBreedingField(selected = "") {
    const rows = state.breedings.slice().sort((left, right) => String(right.breedingDate || "").localeCompare(String(left.breedingDate || "")));
  ...
  function offspringForLitter(litter) {
    ...
    return state.animals.filter((animal) => ids.has(animal.id) || animal.sourceBirthId === litter?.id);
  }

  function renderLitters() {
    const rows = state.litters.slice().sort((left, right) => (right.birthDate || "").localeCompare(left.birthDate || ""));
  ...
  function openLitterForm(id = "", breedingId = "") {
    const existingLinkedBirth = !id && breedingId
      ? state.litters.find((record) => record.breedingId === breedingId)
      : null;
    ...
    const linkedBreeding = state.breedings.find((record) => record.id === breedingId);
    const litter = state.litters.find((record) => record.id === id) || {
      breedingId: linkedBreeding?.id || "",
      damId: linkedBreeding?.femaleId || "",
      sireId: linkedBreeding?.maleId || ""
    };
    const dam = state.animals.find((animal) => animal.id === litter.damId);
    ...
    const updateWeanDate = (force = false) => {
      const selectedDam = state.animals.find((animal) => animal.id === damInput.value);
    ...
    const updateFromBreeding = () => {
      const record = state.breedings.find((item) => item.id === breedingInput.value);
      if (!record) return;
    ...
    form.addEventListener("submit", (event) => {
      ...
      const selectedDam = state.animals.find((animal) => animal.id === data.damId);
      const selectedSire = state.animals.find((animal) => animal.id === data.sireId);
      ...
      const linkedRecord = state.breedings.find((record) => record.id === data.breedingId);
      ...
      if (data.breedingId && state.litters.some((record) => record.id !== id && record.breedingId === data.breedingId)) return toast("That breeding already has a linked birth record. Edit the existing birth instead.", "error");
      ...
      if (id) Object.assign(saved, data, { updatedAt: now, offspringIds: Array.isArray(saved.offspringIds) ? saved.offspringIds : [] });
        ...
        state.litters.push(saved);
      }
      if (previousBreedingId && previousBreedingId !== data.breedingId) {
        const previousBreeding = state.breedings.find((record) => record.id === previousBreedingId);
      ...
      if (data.breedingId) {
        const breeding = state.breedings.find((record) => record.id === data.breedingId);
        if (breeding) {
    ...
    $("#delete-litter")?.addEventListener("click", () => {
      ...
      state.breedings.forEach((record) => {
      ...
      state.litters = state.litters.filter((record) => record.id !== id);
  ...
  function openOffspringCreator(litterId) {
    const litter = state.litters.find((record) => record.id === litterId);
    if (!litter) return;
    const dam = state.animals.find((animal) => animal.id === litter.damId);
    const sire = state.animals.find((animal) => animal.id === litter.sireId);
    ...
    $("#offspring-form").addEventListener("submit", (event) => {
      ...
      for (let index = 0; index < count; index += 1) {
        ...
        if (state.animals.some((animal) => animal.id === animalId)) continue;
      ...
      if (!allowsAnimalTransition(state.animals, [...state.animals, ...created])) return;
  ...
  function filterTasks(tasks = state.tasks, filters = taskView) {
    const today = todayISO();
  ...
  function renderTasks() {
    const today = todayISO();
    const allRows = state.tasks.slice().sort(taskSort);
    ...
    $("#view-tasks").innerHTML = `
      ...
      <div class="panel task-workspace">
        <div class="task-toolbar">
          ...
          <select id="task-animal-filter"><option value="">All animals</option>${state.animals.map((animal) => `<option value="${animal.id}" ${animal.id === taskView.animalId ? "selected" : ""}>${esc(animal.name)}${animal.earTagNumber || animal.tag ? ` · ${esc(animal.earTagNumber || animal.tag)}` : ""}</option>`).join("")}</select>
        </div>
    ...
    $("#task-search").addEventListener("input", (event) => {
      ...
      scheduleUiWork("task-search", () => {
        if (currentRoute === "tasks") renderTaskResults();
      });
    });
  ...
  function renderTaskResults() {
    ...
    $$("[data-task-tomorrow]", root).forEach((button) => button.addEventListener("click", () => {
      const task = state.tasks.find((item) => item.id === button.dataset.taskTomorrow);
      if (!task) return;
  ...
  function budgetPlansFor(monthKey, speciesFilter = "") {
    ...
    return state.budgetPlans.filter((plan) =>
  ...
  function annualBudgetYears() {
    return [...new Set([
      new Date().getFullYear(),
      ...state.annualBudgetPlans.map((plan) => Number(plan.year)).filter(Number.isInteger)
    ])].sort((a, b) => b - a);
  }
  ...
  function budgetYears() {
    ...
    return [...new Set([
      ...
      ...state.transactions.map((transaction) => Number(String(transaction.date || "").slice(0, 4))),
      ...state.budgetPlans.map((plan) => Number(String(plan.month || "").slice(0, 4))),
      ...state.annualBudgetPlans.map((plan) => Number(plan.year))
  ...
  function annualBudgetPlansFor(year, speciesFilter = "") {
    return state.annualBudgetPlans.filter((plan) => {
      ...
      return state.animals.find((animal) => animal.id === plan.animalId)?.species === speciesFilter;
    });
  }
  ...
  function productionSpecies(record) {
    ...
    if (record.animalId) {
      return state.animals.find((animal) => animal.id === record.animalId)?.species || "";
    }
    return "";
  }
  ...
  function productionWarnings(records, allRecords = state.productionRecords) {
  ...
  function latestProductionRecord() {
    return [...state.productionRecords].sort((left, right) =>
  ...
  function syncProductionIncome(record) {
    ...
    if (!(amount > 0)) {
      if (existing) {
        state.transactions = state.transactions.filter((transaction) => transaction.id !== existing.id);
      }
  ...
  function saleAnimals(sale) {
    return saleItems(sale)
      .map((item) => state.animals.find((animal) => animal.id === item.animalId))
      .filter(Boolean);
  }
  ...
  function syncSalePaymentIncome(payment) {
    const sale = state.sales.find((record) => record.id === payment.saleId);
    const existing = state.transactions.find((transaction) =>
    ...
    if (!sale || !(amount > 0)) {
      if (existing) state.transactions = state.transactions.filter((transaction) => transaction.id !== existing.id);
  ...
  function applySaleAnimalStatuses(sale, previousSale = null) {
    ...
    saleItems(sale).forEach((item) => {
      const animal = state.animals.find((record) => record.id === item.animalId);
      if (!animal) return;
  ...
  function renderSales() {
    ...
    const available = state.animals.filter((animal) => animal.status === "For Sale").length;
    const reserved = state.animals.filter((animal) => animal.status === "Reserved").length;
    ...
    $("#view-sales").innerHTML = `
      ...
      <div class="stats-grid">
        ...
        ${statCard("Customers", state.customers.length, "Buyer and contact records")}
  ...
  function openCustomerForm(id = "") {
    const customer = state.customers.find((record) => record.id === id) || {};
    ...
    $("#customer-form").addEventListener("submit", (event) => {
      ...
      else state.customers.push({ id: uid("customer"), ...data, createdAt: now, updatedAt: now });
      state.sales
    ...
    $("#delete-customer")?.addEventListener("click", () => {
      if (state.sales.some((sale) => sale.customerId === id)) {
        toast("This customer is connected to a sale and must be kept for document history.", "error");
        return;
      }
      if (!confirm(`Delete ${customer.name}?`)) return;
      const previousState = structuredClone(state);
      state.customers = state.customers.filter((record) => record.id !== id);
  ...
  function openSaleForm(id = "") {
    ...
    const existing = state.sales.find((record) => record.id === id);
    ...
    openModal(id ? `Edit ${draft.saleNumber}` : "Create animal sale", `
      <form id="sale-form">
        <div class="form-grid two">
          <label>Customer<select name="customerId" required>${state.customers.map((customer) => `<option value="${esc(customer.id)}" ${customer.id === draft.customerId ? "selected" : ""}>${esc(customer.name)}</option>`).join("")}</select></label>
    ...
    form.addEventListener("submit", (event) => {
      ...
      const items = $$('[data-sale-animal]:checked', form).map((box) => {
        ...
        const animal = state.animals.find((record) => record.id === animalId);
      ...
      const conflict = data.status !== "Cancelled" && state.sales.find((sale) => sale.id !== saleId && sale.status !== "Cancelled" && saleItems(sale).some((item) => items.some((next) => next.animalId === item.animalId)));
      if (conflict) {
      ...
      window.HerdHarborMarket?.recordSaleChange?.(saved, previousSale, state);
      closeModal();
  ...
  function openSaleDetail(saleId) {
    const sale = state.sales.find((record) => record.id === saleId);
    if (!sale) return;
    const customer = state.customers.find((record) => record.id === sale.customerId);
  ...
  function openPaymentForm(saleId, paymentId = "") {
    const sale = state.sales.find((record) => record.id === saleId);
    const payment = state.payments.find((record) => record.id === paymentId) || { type: salePayments(saleId).length ? "Payment" : "Deposit", date: todayISO(), method: "Cash", amount: "" };
    if (!sale) return;
    ...
    $("#payment-form").addEventListener("submit", (event) => {
      ...
      else state.payments.push(saved);
    ...
    $("#delete-payment")?.addEventListener("click", () => {
      ...
      const previousState = structuredClone(state);
      state.payments = state.payments.filter((record) => record.id !== paymentId);
      state.transactions = state.transactions.filter((transaction) => transaction.id !== payment.transactionId && !(transaction.sourceType === "sale-payment" && transaction.sourceId === paymentId));
  ...
  function deleteSaleRecord(saleId) {
    ...
    state.payments = state.payments.filter((payment) => !paymentIds.has(payment.id));
    state.transactions = state.transactions.filter((transaction) => !(transaction.sourceType === "sale-payment" && paymentIds.has(transaction.sourceId)));
    const cancelled = { ...sale, status: "Cancelled", items: saleItems(sale) };
    applySaleAnimalStatuses(cancelled, sale);
    state.sales = state.sales.filter((record) => record.id !== saleId);
    if (!saveState("Sale deleted.")) {
      state = previousState;
      return;
    }
    window.HerdHarborMarket?.recordSaleChange?.(cancelled, sale, state);
    closeModal();
    renderSales();
  }
  ...
  function printSaleDocument(saleId, documentType) {
    ...
    const payments = salePayments(sale.id);
    const operation = state.profile?.operationName || "HerdHarbor";
    const sellerContact = [state.profile?.ownerName, state.profile?.phone, state.profile?.email, state.profile?.address].filter(Boolean).join(" · ");
    ...
    const billDetails = documentType === "Bill of Sale" ? `<section><h2>Animals transferred</h2>${saleAnimals(sale).map((animal) => {
      const sire = state.animals.find((record) => record.id === animal.sireId);
      const dam = state.animals.find((record) => record.id === animal.damId);
    ...
    <section class="parties"><div class="box"><small>Seller</small><strong>${esc(state.profile?.ownerName || operation)}</strong><div>${esc(sellerContact || "—")}</div></div><div class="box"><small>Buyer</small><strong>${esc(customer.name)}</strong><div>${esc(buyerContact || "—")}</div></div></section>
  ...
  function transferAnimalsForSale(sale) {
    ...
    return { subjectIds: [...subjectIds], animals: [...included].map((id) => state.animals.find((record) => record.id === id)).filter(Boolean).map(transferableAnimal) };
  }
  ...
  function exportAnimalTransfer(saleId) {
    ...
    const payload = {
      ...
      sender: { operationName: state.profile?.operationName || "", ownerName: state.profile?.ownerName || "", email: state.profile?.email || "", phone: state.profile?.phone || "" },
  ...
  function transferMatch(animal) {
    ...
    for (const fieldName of fields) {
      ...
      if (!value) continue;
      const matches = state.animals.filter((record) => String(record[fieldName] || "").trim().toLowerCase() === value);
  ...
  async function handleTransferImport(event) {
    ...
    try {
      ...
      if (state.transfers.some((record) => record.sourceTransferId === payload.transferId)) {
      ...
      payload.animals.forEach((source) => {
        ...
        if (state.animals.some((animal) => animal.id === mappedId)) return;
      ...
      if (!allowsAnimalTransition(state.animals, [...state.animals, ...added])) {
        state = previousState;
        previousState = null;
        return;
      }
      state.animals.push(...added);
  ...
  function renderBudget() {
    ...
    const productionRecords = filterProductionRecords(state.productionRecords, productionReportView)
      .sort((a, b) => (b.date || "").localeCompare(a.date || ""));
    ...
    const productionProducts = [...new Set(state.productionRecords.map((record) => record.product).filter(Boolean))]
      .sort((left, right) => left.localeCompare(right));
    const productionSpeciesOptions = [...new Set([
      ...state.settings.species,
      ...state.productionRecords.map((record) => productionSpecies(record)).filter(Boolean)
    ])].sort((left, right) => left.localeCompare(right));
    const productionAnimals = state.animals
      .filter((animal) => state.productionRecords.some((record) => record.animalId === animal.id) || animal.status === "Active")
      .sort((left, right) => String(left.name || "").localeCompare(String(right.name || "")));
    ...
    const monthSetting = state.budgetMonthSettings?.[monthKey] || {};
    const yearlyHeadCountOverrideCount = isYearView
      ? Object.entries(state.budgetMonthSettings || {}).filter(([key, setting]) =>
      ...
      <div class="budget-filters">
        ...
        <label>Species
          <select id="budget-species">
            ...
            ${state.settings.species.map((species) =>
    ...
    $("#production-report-species").addEventListener("change", (event) => {
      ...
      if (productionReportView.animalId) {
        const selectedAnimal = state.animals.find((animal) => animal.id === productionReportView.animalId);
    ...
    $("#production-report-animal").addEventListener("change", (event) => {
      ...
      const selectedAnimal = state.animals.find((animal) => animal.id === event.target.value);
    ...
    $("#clear-annual-budget")?.addEventListener("click", () => {
      ...
      state.annualBudgetPlans = state.annualBudgetPlans.filter((plan) => !selectedIds.has(plan.id));
    ...
    $$("[data-production-history]", $("#view-budget")).forEach((button) =>
      button.addEventListener("click", () => {
        ...
        const animal = state.animals.find((item) => item.id === productionReportView.animalId);
    ...
    $$("[data-delete-budget-plan]", $("#view-budget")).forEach((button) =>
      button.addEventListener("click", () => {
        ...
        state.budgetPlans = state.budgetPlans.filter((plan) => plan.id !== button.dataset.deleteBudgetPlan);
  ...
  function openProductionForm(id = "", options = {}) {
    const existingRecord = state.productionRecords.find((item) => item.id === id);
    ...
    const repeatSource = options.repeatId
      ? state.productionRecords.find((item) => item.id === options.repeatId)
      : null;
    ...
    form.addEventListener("submit", (event) => {
      ...
      const savedRecord = {
        ...
        species: data.scope === "Operation"
          ? ""
          : data.scope === "Animal"
            ? state.animals.find((animal) => animal.id === data.animalId)?.species || data.species
            : data.species,
      ...
      const persistedRecord = existingRecord
        ...
        : savedRecord;
      if (!existingRecord) state.productionRecords.push(persistedRecord);
    ...
    $("#delete-production")?.addEventListener("click", () => {
      ...
      const previousState = structuredClone(state);
      state.productionRecords = state.productionRecords.filter((item) => item.id !== id);
  ...
  function openTransactionForm(id = "", defaultType = "Expense") {
    ...
    if (existingTransaction?.sourceType === "sale-payment" && existingTransaction.sourceId) {
      const payment = state.payments.find((record) => record.id === existingTransaction.sourceId);
    ...
    $("#transaction-form").addEventListener("submit", (event) => {
      ...
      if (data.scope === "Animal") {
        data.species = state.animals.find((animal) => animal.id === data.animalId)?.species || "";
      }

      if (id) Object.assign(transaction, data, { updatedAt: new Date().toISOString() });
      else state.transactions.push({ id: uid("transaction"), ...data, createdAt: new Date().toISOString() });
  ...
  function openBudgetPlanForm(monthKey = currentMonthKey(), speciesFilter = "") {
    const setting = state.budgetMonthSettings?.[monthKey] || {};
    ...
    $("#budget-plan-form").addEventListener("submit", (event) => {
      ...
      const existing = state.budgetPlans.find((plan) =>
      ...
      if (!data.species) {
        state.budgetMonthSettings[data.month] = {
          ...(state.budgetMonthSettings[data.month] || {}),
    ...
    const csv = [
      ...
      ...rows.map((transaction) => {
        const production = transaction.sourceType === "production"
          ? state.productionRecords.find((record) => record.id === transaction.sourceId)
          : null;
        return [
          transaction.date,
          transaction.type,
  ...
  function renderSettings() {
    ...
    const marketConsent = window.HerdHarborMarket?.getConsent?.(state) || defaultState.settings.marketAnalyticsConsent;
    ...
    $("#view-settings").innerHTML = `
      ...
      <div class="settings-grid">
        ...
        <article class="settings-card">
          ...
          <div class="action-row">
            <button class="button button-primary" type="button" data-pwa-install>Install HerdHarbor</button>
          </div>
        </article>
        ...
        <details class="settings-about">
          ...
          <div class="detail-grid">
            ${detailField("Version", `${window.HerdHarborBuild?.channel || "Alpha"} v${APP_VERSION}`)}
            ${detailField("Build", window.HerdHarborBuild?.buildId || "Development")}
    ...
    $("#market-analytics-consent-form").addEventListener("submit", async (event) => {
      ...
      try {
        await window.HerdHarborMarket?.setConsent?.(state, {
          enabled,
          includeHistorical,
    ...
    $("#settings-safety-backup").addEventListener("click", () => {
    ...
    window.HerdHarborPWA?.refreshInstallUI();
    refreshSyncStatus(sync);
    refreshDeviceStorageSummary();
  }

  function openAccountDeletionForm() {
    const account = window.HerdHarborCloud?.getSyncDetails?.() || {};
    openModal("Request account deletion", `
      <form id="account-deletion-form">
        ...
        <div class="pedigree-warning">
          <strong>Before continuing</strong>
          <p>Export a backup if you want to keep your records. Downloaded backups and local copies on other devices are not deleted automatically.</p>
        </div>
        ...
        <label style="margin-top:16px">Reason (optional)
          <textarea id="account-deletion-reason" maxlength="1000" placeholder="You may leave this blank."></textarea>
        </label>
        <label>Type DELETE to confirm
          <input id="account-deletion-confirmation" autocomplete="off" pattern="DELETE" required>
        </label>
        <label class="checkbox-row">
          <input id="account-deletion-understand" type="checkbox" required>
          <span>I understand this requests permanent deletion of my account, associated cloud data, and linked Market Analytics data.</span>
        </label>
    ...
    $("#account-deletion-form").addEventListener("submit", async (event) => {
      ...
      try {
        const result = await window.HerdHarborCloud?.requestAccountDeletion?.({
  ...
  function openFeedbackForm() {
    ...
    const deviceSummary = [
      ...
      navigator.platform || "Platform unavailable",
    ...
    openModal("Send tester feedback", `
      <form id="feedback-form" action="https://formspree.io/f/xpqvpwwb" method="POST">
        ...
        <input type="hidden" name="app_version" value="HerdHarbor Alpha v${APP_VERSION}">
        <input type="hidden" name="current_url" value="${esc(window.location.href)}">
        ...
        <div class="form-grid two">
          ...
          ${selectField(
            "Feedback type",
            "feedback_type",
            ["Bug", "Confusing workflow", "Feature request", "Missing field", "Mobile display issue", "Other"],
            "Bug",
            true
          )}
          <label>App section
            <select name="app_section" required>
              ${routeOptions.map(([value, label]) =>
                `<option value="${value}" ${value === currentRoute ? "selected" : ""}>${label}</option>`
              ).join("")}
            </select>
          </label>
        </div>
        ...
        ${textareaField(
          "What happened, or what would you like changed?",
          "details",
          "",
          true
        )}
        ...
        ${textareaField(
          "Screenshot, error message, or additional description",
        ...
        <label>
          ...
          <select name="device_type" required>
            ...
            <option>Desktop or laptop</option>
            <option>Other</option>
          </select>
        </label>

        <label style="display:flex;grid-template-columns:auto 1fr;align-items:flex-start;gap:10px">
          <input type="checkbox" name="permission_to_contact" value="Yes" style="width:18px;height:18px;margin-top:2px">
          <span>You may contact me about this feedback.</span>
        </label>

        <p class="feedback-privacy">
          This form sends the information above, the current app page, and basic browser/device details to the HerdHarbor tester-feedback inbox. It does not send your livestock records.
        </p>

        <div class="modal-actions">
          <button type="button" class="button button-ghost" id="cancel-feedback">Cancel</button>
          <button type="submit" class="button button-primary" id="submit-feedback">Send feedback</button>
        </div>
