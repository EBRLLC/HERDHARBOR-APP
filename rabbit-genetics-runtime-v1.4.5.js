(function(root,factory){const Base=(typeof module==='object'&&module.exports)?require('./rabbit-genetics-engine-v1.4.5.js'):root.HerdHarborBreedingIntelligenceCore;const api=factory(Base||{});if(typeof module==='object'&&module.exports)module.exports=api;if(root)root.HerdHarborBreedingIntelligenceCore=api;})(typeof globalThis!=='undefined'?globalThis:this,function(Base){
'use strict';
const VERSION='2.1.1', RELEASE_VERSION='1.4.5';
