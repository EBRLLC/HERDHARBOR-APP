...
These answers summarize the current HerdHarbor Alpha v1.2.0 behavior. Confirm them in Play Console against the final production configuration before submission.
