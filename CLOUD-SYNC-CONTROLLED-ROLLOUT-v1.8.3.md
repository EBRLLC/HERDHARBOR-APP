...
1. Confirm current production application identity is HerdHarbor Alpha v1.8.4, legacy full-state sync remains authoritative, normalized authority is still gated, and production cloud telemetry is available.
