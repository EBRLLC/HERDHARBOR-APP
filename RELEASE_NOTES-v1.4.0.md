...
- The PWA service worker now caches the genetics core, integration layer, and styles for installed/offline use.
...
Initial v1.4.0 genetics validation should prioritize rabbit breeders with known pedigrees and documented litter colors. Feedback should focus on terminology, missing varieties, pedigree evidence quality, prediction clarity, and cases where modifier genes affect the visible result.
