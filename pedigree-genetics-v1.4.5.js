(function(root,factory){
  ...
  function ensureStyles(doc){if(!doc?.head||doc.getElementById('hh-pedigree-genetics-style'))return;const link=doc.createElement('link');link.id='hh-pedigree-genetics-style';link.rel='stylesheet';link.href='pedigree-genetics-v1.4.5.css?v=1.4.5';doc.head.appendChild(link);}
