    ...
    addScript("hh-v171-stability-hotfix", "herdharbor-v1.7.1-stability-hotfix.js?v=2", () => {
      addScript("hh-phase1-workflow-v171", "workflow-phase1-v1.7.1.js?v=2", () => {
        addScript("hh-flow-phase1-v182", "flow-phase1-v1.8.2.js?v=1", () => {
          // Phase Two registers first so animal-profile routes supersede the temporary
          // Phase One modal handoff while the Phase One completion layer continues to
          // own exact Task/Show targeting and save-return bookkeeping.
