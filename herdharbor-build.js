(function (root) {
  ...
  root.HerdHarborBuild = Object.freeze({
    ...
    channel: "Alpha",
    version: "1.8.0",
    buildId: "subscription-engine-1",
    build: "1.8.0-alpha-subscription-engine-1"
  });

  // Alpha v1.8.0 adds the standalone Subscription Engine while preserving the
  // v1.7.1 stable domain engines, Phase 1 animal-first workflow, and v1.7.0 ARBA layers.
