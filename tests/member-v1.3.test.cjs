...
const releaseNotes = fs.readFileSync(path.join(root, "RELEASE_NOTES-v1.6.1.md"), "utf8");

// v1.6.1 is additive: the proven v1.3.0 Member cattle workflow remains intact.
