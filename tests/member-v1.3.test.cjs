...
assert.match(appRuntime, /name="earTagNumber"/);
assert.match(appRuntime, /name="earTagColor"/);
assert.match(appRuntime, /cattle-ear-field/);
assert.match(appRuntime, /toLowerCase\(\) === "cattle"/);
assert.match(appRuntime, /a\.earTagNumber, a\.earTagColor/);
