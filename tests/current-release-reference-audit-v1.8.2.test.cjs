...
test("PWA shell and HTML use the v1.8.2 release/cache identity", () => {
  ...
  assert.ok(html.indexOf("health-runtime-v1.8.3.js?v=1") < html.indexOf("herdharbor-app-runtime.js?v=2"), "Health domain module loads before the composition runtime");
