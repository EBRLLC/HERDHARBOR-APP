...
assert.match(worker, /rabbit-genetics-runtime-v1\.6\.1\.js\?v=1\.6\.5/);
assert.match(worker, /shows-v1\.6\.1\.js\?v=1\.6\.5/);
assert.match(worker, /shows-v1\.6\.1-hardening\.js\?v=1\.6\.5/);
