...
assert.match(worker, /v0\.5\.1-20260809-1/);
assert.match(worker, /herdharbor-cloud\.js\?v=11/);
assert.match(worker, /pwa\.js\?v=13/);
assert.match(worker, /spreadsheet-import\.js\?v=10/);
assert.match(pwa, /0\.5\.1-launch-hardening-1/);
