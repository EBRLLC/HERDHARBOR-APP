...
// The recovered consolidated shell remains intact; HerdHarborBuild is authoritative for v1.6.7.
...
assert.match(worker, /rabbit-genetics-runtime-v1\.6\.1\.js\?v=1\.6\.7/);
...
console.log("Alpha v1.6.7 launch hardening, PWA update independence, and account-safety tests passed");
