...
const Core=require("../rabbit-genetics-engine-compat-v1.6.1.js");

assert.equal(Core.RELEASE_VERSION,"1.6.1");
...
const recordsSource=fs.readFileSync(path.join(__dirname,"..","rabbit-records-v1.6.1.js"),"utf8");
...
const releaseSource=fs.readFileSync(path.join(__dirname,"..","herdharbor-release-v1.6.1.js"),"utf8");
