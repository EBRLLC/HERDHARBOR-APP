...
test("v1.7.0 reference-guide assets remain loaded under the v1.8.0 web release",()=>{
  ...
  assert.match(build,/buildId: "subscription-engine-7"/);
  assert.match(build,/version: "1\.8\.0"/);
