...
assert.equal(twa.appVersion, "1.6.1");
assert.equal(twa.appVersionCode, 10);
...
console.log("Google Play Alpha v1.6.1 membership and stability readiness tests passed");
