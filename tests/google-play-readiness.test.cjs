...
const hardening = read("shows-v1.5.0-hardening.js");
...
assert.ok(fs.existsSync(path.join(root, "shows-v1.5.0.js")));
assert.ok(fs.existsSync(path.join(root, "shows-v1.5.0.css")));
assert.ok(fs.existsSync(path.join(root, "shows-v1.5.0-hardening.js")));
