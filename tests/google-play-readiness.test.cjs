...
assert.match(appGradle, /versionName "1\.0\.3-alpha"/);
...
assert.ok(!fs.existsSync(path.join(root, "android/app/src/main/java/com/herdharbor/app/DelegationService.java")));
assert.ok(!fs.existsSync(path.join(root, "android/app/src/main/java/com/herdharbor/app/LauncherActivity.java")));
...
console.log("Google Play v1.0.3 alpha readiness tests passed");
