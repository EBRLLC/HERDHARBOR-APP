...
const Shows=require("../shows-v1.6.1.js");
...
assert.equal(Shows.VERSION,"1.6.1");
...
const source=fs.readFileSync(path.join(__dirname,"..","shows-v1.6.1.js"),"utf8");
const hardening=fs.readFileSync(path.join(__dirname,"..","shows-v1.6.1-hardening.js"),"utf8");
