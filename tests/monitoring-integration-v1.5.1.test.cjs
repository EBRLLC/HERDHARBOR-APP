...
assert.match(generator, /release: "HerdHarbor@1\.6\.6"/);
...
assert.match(pwa, /herdharbor-monitoring-config\.js\?v=1\.6\.6/);
assert.match(pwa, /vendor\/herdharbor-monitoring-v1\.6\.1\.min\.js\?v=1\.6\.6/);
...
assert.match(worker, /herdharbor-monitoring-config\.js\?v=1\.6\.6/);
assert.match(worker, /herdharbor-monitoring-v1\.6\.1\.min\.js\?v=1\.6\.6/);
...
console.log("Alpha v1.6.6 monitoring integration and scope guardrails passed");
