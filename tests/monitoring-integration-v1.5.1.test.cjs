...
assert.match(generator, /release: "HerdHarbor@1\.8\.2"/);
assert.match(generator, /cloud-sync-v2-state-integrity-1/);
...
assert.match(worker, /herdharbor-monitoring-v1\.6\.1\.min\.js\?v=1\.8\.2/);
