...
assert.match(config, /build: "october-subscription-launch-referrals-credits-4"/);
assert.match(config, /enableTestCrash: false/);
assert.match(generator, /release: "HerdHarbor@1\.8\.1"/);
assert.match(generator, /october-subscription-launch-referrals-credits-4/);
...
assert.match(pwa, /herdharbor-monitoring-config\.js\?v=1\.8\.1/);
assert.match(pwa, /vendor\/herdharbor-monitoring-v1\.6\.1\.min\.js\?v=1\.8\.1/);
...
assert.match(worker, /herdharbor-monitoring-v1\.6\.1\.min\.js\?v=1\.8\.1/);
