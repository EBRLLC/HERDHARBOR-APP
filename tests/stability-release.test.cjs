...
assert.match(serviceWorker, /pedigree-genetics-v1\.5\.1\.css\?v=1\.4\.5/);
assert.match(serviceWorker, /pedigree-genetics-v1\.5\.1\.js\?v=1\.4\.5/);
assert.match(serviceWorker, /breeding-intelligence-core-v1\.5\.1\.js\?v=1\.5\.1/);
assert.match(serviceWorker, /breeding-intelligence-v1\.5\.1\.css\?v=1\.5\.1/);
assert.match(serviceWorker, /breeding-intelligence-v1\.5\.1\.js\?v=1\.5\.1/);
assert.match(serviceWorker, /rabbit-records-v1\.5\.1\.js\?v=1\.4\.5/);
assert.match(serviceWorker, /rabbit-genetics-engine-v1\.5\.1\.js\?v=1\.4\.5/);
assert.match(serviceWorker, /rabbit-genetics-runtime-v1\.5\.1\.js\?v=1\.4\.5/);
assert.match(serviceWorker, /rabbit-genetics-ui-v1\.5\.1\.js\?v=1\.4\.5/);
assert.match(serviceWorker, /herdharbor-release-v1\.5\.1\.js\?v=1\.4\.5/);
assert.match(serviceWorker, /shows-v1\.5\.1\.css\?v=1\.5\.0/);
assert.match(serviceWorker, /shows-v1\.5\.1\.js\?v=1\.5\.0/);
assert.match(serviceWorker, /shows-v1\.5\.1-hardening\.js\?v=1\.5\.0/);
