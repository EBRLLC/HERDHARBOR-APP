...
assert.match(html, /HerdHarbor installable tester build v0\.5\.2/);
...
assert.match(serviceWorker, /v0\.5\.2-/);
assert.match(serviceWorker, /v0\.5\.2-20260809-2/);
assert.match(serviceWorker, /spreadsheet-import\.js\?v=11/);
assert.match(serviceWorker, /herdharbor-cloud\.js\?v=12/);
assert.match(serviceWorker, /pwa\.js\?v=15/);
assert.match(serviceWorker, /qrcode-generator-1\.4\.4\.js/);

console.log("v0.5.2 stability release tests passed");
