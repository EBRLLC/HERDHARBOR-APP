...
// v1.6.1 remains additive: the legacy app/data model stays intact while release assets overlay it.
assert.match(html, /HerdHarbor Alpha v1\.6\.1 consolidated application shell/);
...
assert.match(serviceWorker, /pedigree-genetics-v1\.6\.1\.css\?v=1\.6\.1/);
assert.match(serviceWorker, /pedigree-genetics-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /breeding-intelligence-core-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /breeding-intelligence-v1\.6\.1\.css\?v=1\.6\.1/);
assert.match(serviceWorker, /breeding-intelligence-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /rabbit-records-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /rabbit-genetics-engine-advanced-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /rabbit-genetics-runtime-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /rabbit-genetics-ui-compat-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /rabbit-genetics-ui-advanced-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /herdharbor-release-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /shows-v1\.6\.1\.css\?v=1\.6\.1/);
assert.match(serviceWorker, /shows-v1\.6\.1\.js\?v=1\.6\.1/);
assert.match(serviceWorker, /shows-v1\.6\.1-hardening\.js\?v=1\.6\.1/);
...
console.log("Alpha v1.6.1 membership + independent PWA update release stability tests passed");
