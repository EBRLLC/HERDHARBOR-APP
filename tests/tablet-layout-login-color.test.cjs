...
// inline fallback; HerdHarborBuild is authoritative for the current v1.7.0 identity.
...
assert.ok(worker.includes("shows-v1.6.1.css?v=1.7.0"));
...
console.log("Alpha v1.7.0 tablet containment, PWA cache freshness, existing pedigree genetics, Help, and login color tests passed");
