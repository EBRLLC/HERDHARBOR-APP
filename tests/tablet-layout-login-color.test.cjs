...
// HerdHarborBuild is authoritative for the current web Alpha identity; established login/layout runtimes remain v1.7.1.
...
console.log("Alpha v1.8.0 web-shell tablet containment, PWA cache freshness, existing pedigree genetics, Help, and login color tests passed");
