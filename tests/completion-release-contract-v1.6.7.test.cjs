...
test("v1.6.7 release review runs completion and dual-timezone regression without duplicating the Android PR build", () => {
  ...
  assert.equal(pkg.scripts["test:completion"], "node --test tests/completion-release-contract-v1.6.7.test.cjs tests/current-release-reference-audit-v1.7.1.test.cjs");
});
