(function(root,factory){
  ...
  function ensureStyles(doc){if(!doc?.head||doc.getElementById('hh-pedigree-genetics-style'))return;const link=doc.createElement('link');link.id='hh-pedigree-genetics-style';link.rel='stylesheet';link.href='pedigree-genetics-v1.6.1.css?v=1.6.1';doc.head.appendChild(link);}
