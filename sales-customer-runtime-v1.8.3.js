(function (root, factory) {
  ...
  function create(deps = {}) {
    ...
    function printSaleDocument(saleId, documentType) {
      ...
      popup.root.document.write(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(documentType)} ${esc(sale.saleNumber)}</title><style>
